...
const DateTimePicker = Dynamic<any>(
  (() =>
...
const LocalizationProvider = Dynamic<any>(
  (() =>
...
const Interview: NextPage = ({ pagedata }: any) => {
  ...
  const handleSubmit = async (e: any) => {
    ...
    axios({
      url: `${process.env.API}${router.locale}/account/submissions/interview`,
  ...
  return (
    <>
      ...
      <Layout pagedata={pagedata}>
        ...
        {pagedata?.profile && (
          <>
            <Stepper settings={{ active: 2 }}></Stepper>
